...
## Steps
1. **Verify environment setup.** Run `GSSETENV` or the equivalent CL to confirm the program sees the correct data, work, and stored procedure libraries. Record the output values.
